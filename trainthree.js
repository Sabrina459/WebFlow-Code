!function (e) {
    ...
    }, r.p = "https://cpwebassets.codepen.io/assets/packs/", r(r.s = 706)
}({
    706: function (e, t, r) {
        "use strict";
        r.r(t);
        var n = {
            ...
            var n = f(e), i = e.user ? e.user : "anon", a = e["slug-hash"];
            return void 0 !== e.token && (a += "/" + e.token), [t, i, r, a + "?" + n].join("/").replace(/\/\//g, "//")
        }, p = function (e) {
